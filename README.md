...
[![MCP Scorecard: 90/100](https://img.shields.io/badge/proofof.ai-90%2F100-5b21b6)](https://proofof.ai/scorecard/meok-ap2-mandate-mcp.html)
...
```json
{
  "mcpServers": {
    "meok-ap2-mandate-mcp": {
      "command": "uvx",
      "args": ["meok-ap2-mandate-mcp"]
    }
  }
}
```

Or: `pip install meok-ap2-mandate-mcp` then run the `meok-ap2-mandate-mcp` command (stdio transport).
